...
let botaoPorcentagem = document.querySelector(".js-btn-porcentagem");
...
function calcularPorcentagem() {
  if (elementoResultado.value) {
    try {
      let valorAtual = eval(elementoResultado.value);
      elementoResultado.value = valorAtual / 100;
    } catch {
      alert("Operação inválida para porcentagem.");
    }
  }
}
